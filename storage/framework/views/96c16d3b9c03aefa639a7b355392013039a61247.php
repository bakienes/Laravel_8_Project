...
<div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="/service" class="nav-item nav-link">Hizmetlerimiz</a>
                    <a href="/price" class="nav-item nav-link">Fiyatlarımız</a>
    ...
    <!-- Navbar End -->
<?php /**PATH C:\Users\Bey\Desktop\TestBlog\resources\views/frontend/kutuphane/menu.blade.php ENDPATH**/ ?>