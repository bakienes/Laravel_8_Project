...
<?php $results = DB::select('SELECT * FROM admins where id = ?', array(1)); ?>
      <!-- partial -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Hoşgeldin Patron, "<?php echo e(session('user')); ?>"</h4>
                </div>
                <div>
          ...
          <div class="row">
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Toplam Sayfa Sayısı</p>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Makale Görüntülenme Sayısı  </p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
...
<script src="<?php echo e(asset('back/')); ?>/vendors/base/vendor.bundle.base.js"></script>
  ...
  <script src="<?php echo e(asset('back/')); ?>/vendors/chart.js/Chart.min.js"></script>
  ...
  <script src="<?php echo e(asset('back/')); ?>/js/mdb.min.js"></script>
<?php echo $__env->make('backend.kutuphane.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Bey\Desktop\TestBlog\resources\views/adminpanel.blade.php ENDPATH**/ ?>