            ...
            <div class="row pb-3">
                <div class="col-md-6 col-lg-5 mb-5">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <h3 class="mb-3">Kitap Adı: <?php echo e($book->name); ?></h3>
                        <h4 class="mb-4">Kitap Kodu: <?php echo e($book->book_code); ?></h4>
                        <p>Kitap İçerik: <?php echo e($book->author); ?></p>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.kutuphane.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Bey\Desktop\TestBlog\resources\views/index.blade.php ENDPATH**/ ?>